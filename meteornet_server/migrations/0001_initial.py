...
import meteornet_server.stations.models
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('component', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='meteornet_server.Component')),
            ],
        ),
        migrations.CreateModel(
            name='Measurement',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('maintainers', models.ManyToManyField(to='meteornet_server.Person')),
            ],
        ),
        migrations.CreateModel(
            name='Status',
        ...
        migrations.AddField(
            model_name='station',
            name='status',
            field=models.ForeignKey(default=meteornet_server.stations.models.get_status_default, on_delete=django.db.models.deletion.SET_DEFAULT, to='meteornet_server.Status'),
        ),
        migrations.AddField(
            model_name='measurement',
            name='batch',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='meteornet_server.MeasurementBatch'),
        ),
        migrations.AddField(
            model_name='component',
            name='station',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='meteornet_server.Station'),
        ),
    ]
