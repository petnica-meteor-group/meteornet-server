...
if os.environ.get('DJANGO_DEBUG'):
    ...
    DEBUG = False
    ALLOWED_HOSTS = [ 'meteori.petnica.rs', 'www.meteori.petnica.rs', '10.51.0.54' ]
...
INSTALLED_APPS = [
    ...
    'meteor_network_server.apps.MeteorNetworkServerConfig',
]
...
ROOT_URLCONF = 'meteor_network_server.urls'
...
WSGI_APPLICATION = 'meteor_network_server.wsgi.application'
...
STATIC_ROOT = '/srv/http/meteor_network_server/static'
